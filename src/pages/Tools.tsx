...
const toolCategories = [
  ...
  },
  {
    ...
    tools: [
      { name: "Google Analytics", desc: "Website traffic analysis", logo: "" },
      { name: "Meta Pixel", desc: "Facebook conversion tracking", logo: "" },
      { name: "Google Tag Manager", desc: "Tag management system", logo: "" },
      { name: "Hotjar", desc: "Heatmaps & user behavior", logo: "" },
    ],
  },
  {
    category: "Design & Content",
    tools: [
      { name: "Canva Pro", desc: "Graphic design & social media creatives", logo: "" },
      { name: "Adobe Creative Suite", desc: "Professional design tools", logo: "" },
      { name: "CapCut", desc: "Video editing for TikTok & Reels", logo: "" },
      { name: "Figma", desc: "UI/UX design & prototyping", logo: "" },
    ],
  },
  {
    category: "Email & Automation",
    tools: [
      { name: "Klaviyo", desc: "E-commerce email marketing", logo: "" },
      { name: "Mailchimp", desc: "Email campaigns & automation", logo: "" },
      { name: "Zapier", desc: "Workflow automation", logo: "" },
    ],
  },
  {
    category: "SEO & Research",
    tools: [
      { name: "SEMrush", desc: "SEO & competitive analysis", logo: "" },
      { name: "Ahrefs", desc: "Backlink analysis & keyword research", logo: "" },
                  ...
                  {cat.tools.map((tool, ti) => (
                    <ScrollReveal key={ti} delay={ti * 0.05}>
                      <div className="glass-card rounded-xl p-6 text-center h-full group hover:glow-gold transition-all">
                        {tool.logo ? (
                          <img src={tool.logo} alt={tool.name} className="h-8 mx-auto mb-3 object-contain grayscale group-hover:grayscale-0 transition-all" loading="lazy" />
                        ) : (
